...
<br/>
<br/>
            <form action="relatorio_saida.php" method="post" id="entrada">
 ...
 <label for="calendario3">Inicio:</label> <input type="text" name="calendario3" id="calendario3">
  <label for="calendario4">Fim:</label> <input type="text" name="calendario4" id="calendario4">
               ...
               <select name="residuo_classificado" class="mainselection">
                    <option value="0">Escolher residuo</option>
           ...
           <select name="destino" class="mainselection">
                    <option value="0">Aguardando residuo...</option>
                     ...
                     <select name="empresa" class="mainselection">
                    <option value="100">Escolher empresa</option>
                    <option value="0">Todos</option>
                    <?php
...
<br/>
   ...
   $result = pg_query($connection, "SELECT d.id_destinacao, d.residuo_classificado, d.peso,TO_CHAR(d.data, 'DD/MM/YYYY') as data, d.tipo_destino, 
       d.nome_empresa FROM destinacao as d ");
