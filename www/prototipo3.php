    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="" method="post" id="relatorio_entrada">
                ...
                <label id="setorff">Setor:</label>
                <select name="setor" class="mainselection" id="setorf">
                ...
                <label id="municipioff">Municipio:</label>
                <select name="municipio" class="mainselection" id="municipiof">
                    
                    <option value="0">Todos</option>
                </select>
                <label id="coletaff">Tipo de Coleta:</label>
                ...
                <label id="residuoff">Tipo de Residuo:</label>
