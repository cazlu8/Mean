<?php
    $connection = pg_connect("host=localhost port=5432 dbname=pem user=postgres password=root");
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <div id="conteudo" class="navbar-inner">
        ...
        <div class="container">
            ...
            <form action="" method="post" id="entrada">
                <label for="calendario">Data:</label> <input type="text" name="calendario" id="calendario">
